...
let logUIConfigurationObject = {
    ...
    trackingConfiguration: {
        ...
        'facts-hover': {
            selector: 'div.grid-container > div.facts > div.facts-container > ul > li',
            event: 'mouseHover',
            properties: {
                mouseenter: {
                    name: 'FACTS_HOVERIN',
        ...
        'web-hover': {
            selector: 'div.grid-container > div.web-results > div.results-container > ul > li',
            event: 'mouseHover',
            properties: {
                mouseenter: {
        ...
        'web-snippet-hover': {
            selector: 'div.grid-container > div.web-results > div.results-container > ul > li > span.snippet',
            event: 'mouseHover',
            properties: {
                mouseenter: {
